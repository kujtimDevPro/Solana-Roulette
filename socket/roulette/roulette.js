...
module.exports = function (model, config) {
	...
	// console.log('gameStartCount  config.rouletteStartTime -->', gameStartCount);
	var module = {};
	module.gameCount = async function (callback) {
		try {
			// console.log('--> module.gameCount ');
	...
	module.rouletteLogic = async function (callback) {
		try {
			...
			// console.log('rouletteHistoryDetail -->',rouletteHistoryDetail);
			...
			// console.log('roilletTBLupdate -->', roilletTBLupdate);
			...
			/* console.log('dangerArray -->', dangerArray);
			console.log('greyArray -->', greyArray);
			...
			// console.log('getrouletteDetail.bet_amount ->', getrouletteDetail.bet_amount);
			// console.log('getrouletteDetail.total_amt_carryforward ->', getrouletteDetail.total_amt_carryforward);
			...
			// console.log('getStopColor -->', getStopColor);
